...
namespace CretaceousPark.Models
{
    public class CretaceousParkContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            // ^^ returns an EntityTypeBuilder obj that allow configuring the type specified in the method call
                .HasData(
                    //^^ built-in method that seeds the db with the following entries
